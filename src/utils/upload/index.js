...
import md5 from './md5'
import { initTask, merge, preSignUrl, taskInfo } from '@/api/upload'
 ...
 * 获取一个上传任务，没有则初始化一个
 */
async function getTaskInfo(file, chunkSize = DEFAULT_SIZE) {
  let task
 ...
 */
function handleUpload(file, taskRecord, options, callback = (res) => {}) {
